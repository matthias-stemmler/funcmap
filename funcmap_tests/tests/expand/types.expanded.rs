...
where
    ...
    Foo<
        A,
        A,
    >: ::funcmap::FuncMap<A, B, ::funcmap::TypeParam<0usize>, Output = Foo<B, A>>,
    Foo<
        B,
        A,
    >: ::funcmap::FuncMap<A, B, ::funcmap::TypeParam<1usize>, Output = Foo<B, B>>,
{
    type Output = Test<B>;
                ...
                Self::Output {
                    ...
                    >::func_map(
                        ::funcmap::FuncMap::<
                            ...
                            _,
                            ::funcmap::TypeParam<0usize>,
                        >::func_map(field_repeated, |value| f(value)),
                        |value| f(value),
                    ),
                }
            }
...
where
    ...
    Foo<
        A,
        A,
    >: ::funcmap::TryFuncMap<A, B, ::funcmap::TypeParam<0usize>, Output = Foo<B, A>>,
    Foo<
        B,
        A,
    >: ::funcmap::TryFuncMap<A, B, ::funcmap::TypeParam<1usize>, Output = Foo<B, B>>,
{
    type Output = Test<B>;
